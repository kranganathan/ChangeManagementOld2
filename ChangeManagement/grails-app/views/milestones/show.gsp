...
<html>
    ...
    <body>
        ...
        <div id="show-milestones" class="content scaffold-show" role="main">
            ...
            <f:display bean="milestones" />
            <g:form resource="${this.milestones}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.milestones}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
