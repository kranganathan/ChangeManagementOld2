...
<html>
    ...
    <body>
        ...
        <div id="edit-comments" class="content scaffold-edit" role="main">
            ...
            <g:hasErrors bean="${this.comments}">
            <ul class="errors" role="alert">
                <g:eachError bean="${this.comments}" var="error">
                <li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
                </g:eachError>
            </ul>
            </g:hasErrors>
            <g:form resource="${this.comments}" method="PUT">
                <g:hiddenField name="version" value="${this.comments?.version}" />
                <fieldset class="form">
                    <f:all bean="comments"/>
                </fieldset>
